...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20181224134859_NullableFKTaskToBacklogTask")]
    partial class NullableFKTaskToBacklogTask
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.ConstraintRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.ConstraintRecord", b =>
                {
                    b.HasOne("DataAccessLayer.Entities.Board")
                        .WithMany("Constraints")
                        .HasForeignKey("BoardId");

                    b.HasOne("DataAccessLayer.Entities.Column")
                        .WithMany("Constraints")
